...
def start_consuming():
    try:
        ...
        channel.basic_consume(queue='subscriber1',
                              on_message_callback=callback,
                              auto_ack=True)

        logging.info('Subscriber1 waiting for messages. To exit press CTRL+C')
        ...
        if connection:
            connection.close()
            logging.info("Subscriber1 connection closed")

if __name__ == '__main__':
    logging.info("Subscriber1 started")
    start_consuming()
